...
public class MainActivity extends FragmentActivity  implements OnMapReadyCallback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Switch sLog = (Switch) findViewById(R.id.sLog);
		Switch sGPSBetter = (Switch) findViewById(R.id.sGPSBetter);
		Switch sAccuracy = (Switch) findViewById(R.id.sAccuracy);
		EditText edtTempoGPS = (EditText) findViewById(R.id.edtTempoGPS);
		EditText edtMetriGPS = (EditText) findViewById(R.id.edtMetriGPS);
		EditText edtAccuracy = (EditText) findViewById(R.id.edtAccuracy);
		EditText edtDimThumbs = (EditText) findViewById(R.id.edtDimThumbs);
		EditText edtDimThumbsM = (EditText) findViewById(R.id.edtDimThumbsM);
		ImageView imgMappa = (ImageView) findViewById(R.id.imgMappa);
		ImageView imgChiudeImg = (ImageView) findViewById(R.id.imgChiudeImmagine);
		...
		Button btnSalvaAcc = (Button) findViewById(R.id.btnSalvaACC);
        ...
        TextView txtCoords = (TextView) findViewById(R.id.txtCoords);
		...
		VariabiliStatiche.getInstance().setLista((ListView) findViewById(R.id.lstRisoluzioni));
		...
		Button btnSalvaTGPS = (Button) findViewById(R.id.btnSalvaTGPS);
		...
		Button btnMetriGPS = (Button) findViewById(R.id.btnSalvaMGPS);
		...
		Button btnSalvaDT = (Button) findViewById(R.id.btnSalvaDT);
		...
		Button btnSalvaDTM = (Button) findViewById(R.id.btnSalvaDTM);
		...
		Button cmdVideo = (Button) findViewById(R.id.cmdEsegueVideo);
		cmdVideo.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent Folder = new Intent(MainActivity.this, Video.class);
		...
		RadioButton AS = (RadioButton) findViewById(R.id.optAutoScatto);
		AS.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				RadioButton IM = (RadioButton) findViewById(R.id.optImmediato);
				IM.setChecked(false);
				EditText et = (EditText) findViewById(R.id.txtSecondi);
				et.setEnabled(true);
				Button bi = (Button) findViewById(R.id.cmdImposta);
				bi.setEnabled(true);
		...
		EditText t = (EditText) findViewById(R.id.txtScatti);
		...
		RadioButton or = (RadioButton) findViewById(R.id.optOriginale);
		or.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				RadioButton ma = (RadioButton) findViewById(R.id.optMascherata);
				ma.setChecked(false);
		...
		// VIBRAZIONE
		final CheckBox cb = (CheckBox) findViewById(R.id.chkVibrazione);
		...
		// ANTEPRIMA
		final CheckBox ca = (CheckBox) findViewById(R.id.chkAnteprima);
		...
		// FRONTALE - RETRO
		RadioButton ff = (RadioButton) findViewById(R.id.optFrontale);
		ff.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				RadioButton fr = (RadioButton) findViewById(R.id.optRetro);
				fr.setChecked(false);

				TextView tv = (TextView) findViewById(R.id.txtRisoluzione);
				Impostazioni i = new Impostazioni();
		...
		ListView lvS = (ListView) findViewById(R.id.lstRisoluzioni);
		...
		Button bs = (Button) findViewById(R.id.cmdImpostaScatti);
		...
		final ScrollView lPr = (ScrollView) findViewById(R.id.scrollViewPrincipale);
		lPr.setVisibility(LinearLayout.VISIBLE);

		TextView tTotale = (TextView) findViewById(R.id.txtMemoriaTotale);
		TextView tLibera = (TextView) findViewById(R.id.txtMemoriaLibera);
		TextView tUsata = (TextView) findViewById(R.id.txtMemoriaUsata);
		TextView tInfo = (TextView) findViewById(R.id.txtInfo);
		...
		Button btnTornaIndietro = (Button) findViewById(R.id.btnTornaIndietro);
		...
		TextView tTitEstensione = (TextView) findViewById(R.id.txtTitoloEstensione);
		TextView txtKM = (TextView) findViewById(R.id.txtKM);
		VariabiliStatiche.getInstance().setTxtKM(txtKM);
		VariabiliStatiche.getInstance().setTxtImm((TextView) findViewById(R.id.txtImmagini));
		VariabiliStatiche.getInstance().setTxtNomeImm((TextView) findViewById(R.id.txtNomeImm));
		final LinearLayout lScatti = (LinearLayout) findViewById(R.id.layScatti);
		final LinearLayout lTasti = (LinearLayout) findViewById(R.id.layTasti);
		final LinearLayout lFrecce = (LinearLayout) findViewById(R.id.layFrecce);
		...
		VariabiliStatiche.getInstance().setImg((ImageView) findViewById(R.id.imgScatto));
		VariabiliStatiche.getInstance().setAudio((ImageView) findViewById(R.id.imgPlayAudio));
		VariabiliStatiche.getInstance().setvView((VideoView) findViewById(R.id.videoView1));
		...
		final Button bDecripta = (Button) findViewById(R.id.cmdDecript);
		final Button bCripta = (Button) findViewById(R.id.cmdCript);
		...
		ImageView btnIndietro = (ImageView) findViewById(R.id.imgIndietro);
		...
		VariabiliStatiche.getInstance().setBtnRuotaDes((ImageView) findViewById(R.id.imgRuotaDes));
		VariabiliStatiche.getInstance().setBtnRuotaSin((ImageView) findViewById(R.id.imgRuotaSin));
		...
		TextView txtDataMappa = (TextView) findViewById(R.id.txtDataMappa);
		txtDataMappa.setText(oggi);
		VariabiliStatiche.getInstance().setTxtDataMappa(txtDataMappa);

		ImageView imgRefreshMappa = (ImageView) findViewById(R.id.imgRefreshMappa);
		...
		ImageView imgCentraMappa = (ImageView) findViewById(R.id.imgCentraMappa);
		...
		ImageView imgEliminaMappa = (ImageView) findViewById(R.id.imgEliminaMappa);
		...
		ImageView imgExportMappa = (ImageView) findViewById(R.id.imgExportMappa);
		...
		ImageView imgIndietroMappa = (ImageView) findViewById(R.id.imgIndietroMappa);
		...
		ImageView imgAvantiMappa = (ImageView) findViewById(R.id.imgAvantiMappa);
		...
		final ImageView imgPlayMappa = (ImageView) findViewById(R.id.imgPlayPercorso);
	...
	private void ImpostaCampiTestoPerLingua() {
        ...
        RadioButton ff=(RadioButton) findViewById(R.id.optFrontale);
    	RadioButton fr=(RadioButton) findViewById(R.id.optRetro);
  		TextView tps=(TextView) findViewById(R.id.txtTitTipoScatto);
  		// TextView t1=(TextView) findViewById(R.id.txtTitNick);
  		// TextView t2=(TextView) findViewById(R.id.txtTitPass);
  		TextView tpos=(TextView) findViewById(R.id.txtTitPos);
  		TextView ts=(TextView) findViewById(R.id.textView22);
  		TextView t4=(TextView) findViewById(R.id.txtTitoloEstensione);
  		TextView tr=(TextView) findViewById(R.id.TextView01);
  		CheckBox c=(CheckBox) findViewById(R.id.chkVibrazione);
  		CheckBox ca=(CheckBox) findViewById(R.id.chkAnteprima);
  		TextView tns=(TextView) findViewById(R.id.textView3);
  		...
  		TextView to=(TextView) findViewById(R.id.txtTitOrient);
	...
	private void SistemaSchermata() {
	    ...
	    tabHost = (TabHost) findViewById(R.id.tabGenerale1);
...
//	        tv.setWidth(200);
	...
	private void ImpostaInfo() {
        ...
        TextView tv=(TextView) findViewById(R.id.txtInfoHome);
